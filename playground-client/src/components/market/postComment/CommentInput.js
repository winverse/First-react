...
import CommentWriteInput from './CommentWriteInput';
...
const CommentInput = ({ thubmnail, value, author, message, createAt, comment, _id, onCommentClick }) => {
  ...
  return(
    <Wrapper>
      ...
      <SubBox>
        ...
        <CommentAdd onClick={commentClick}>댓글보기</CommentAdd>
      </SubBox>
      <ReComment>
        <ReCommentContainer id={_id}/>
      </ReComment>
    </Wrapper>
  );
};
